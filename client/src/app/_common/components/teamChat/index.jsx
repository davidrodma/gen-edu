...
import mp3 from '@/app/_common/assets/images/others/mp3-dark.png'
import mp3W from '@/app/_common/assets/images/others/mp3.png'
            ...
            <div className="flex items-end space-x-3">
              <div className="flex items-center space-x-2">
                ...
                <div className="rounded-lg bg-bgray-100 p-3 dark:bg-darkblack-500">
                  <p className="text-sm font-medium text-bgray-900 dark:text-white">Hi, What can I help you with?</p>
                </div>
              </div>
              <span className="text-xs font-medium text-bgray-500">10:00 PM</span>
            </div>
          </div>
          <div className="flex justify-start">
            <div className="flex items-end space-x-3">
