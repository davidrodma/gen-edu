                ...
                <Link href="/users">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <span className="item-text text-lg font-medium leading-none">Users</span>
                    </div>
                  </div>
                </Link>
              </li>
                ...
                <Link href="/configuration">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <span className="item-text text-lg font-medium leading-none">Configuration</span>
                    </div>
                  </div>
                </Link>
              </li>
                ...
                <Link href="/transaction">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <span className="item-text text-lg font-medium leading-none">Transaction</span>
                    </div>
                  </div>
                </Link>
              </li>
                      ...
                      <span className="item-ico">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path
                            ...
                            className="path-1"
                          />
                          <circle cx="17.4444" cy="5.33333" r="3.33333" fill="#22C55E" className="path-2" />
                        </svg>
                      </span>
                ...
                <Link href="/integrations">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <span className="item-text text-lg font-medium leading-none">Integrations</span>
                    </div>
                  </div>
                </Link>
              </li>
              ...
              <li className="item py-[11px] text-bgray-900 dark:text-white">
                <Link href="/not-used/users">
                  <div className="flex items-center space-x-2.5">
                    ...
                    <span className="item-text text-lg font-medium leading-none">Customers</span>
                  </div>
                </Link>
              </li>
              <li className="item py-[11px] text-bgray-900 dark:text-white">
