...
import sa1 from '@/app/_common/assets/images/avatar/sa-1.png'
import sa2 from '@/app/_common/assets/images/avatar/sa-2.png'
import sa3 from '@/app/_common/assets/images/avatar/sa-3.png'
    ...
    <div className="2xl:block hidden">
      ...
      <div className="border border-bgray-200 dark:border-darkblack-400 rounded-lg py-8 px-6 w-full">
        <div className="tab-panel">
          <h4 className="font-medium text-bgray-900 dark:text-white font-poppins text-lg mb-4">Recent Support</h4>
          <RecentSupportItem
            img={sa1}
            name="Joel Becker"
            time="12h"
