      ...
      <div className="flex justify-between mb-7">
        <div className="flex items-center gap-x-3">
          <input
            ...
            id="remember"
          />
          <label htmlFor="remember" className="text-bgray-600 dark:text-bgray-50 text-base">
            By creating an account, you agreeing to our
            <span className="text-bgray-900 dark:text-white">Privacy Policy,</span> and
            <span className="text-bgray-900 dark:text-white">Electronics Communication Policy</span>.
          </label>
        </div>
      </div>
      <button
