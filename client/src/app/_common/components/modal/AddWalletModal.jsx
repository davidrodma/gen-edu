...
import flag from '@/app/_common/assets/images/flag/us-sm.svg'
      ...
      <div className="modal-content md:w-full max-w-3xl px-4">
        <div className="step-content step-1">
          ...
          <div className="max-w-[750px] rounded-lg bg-white dark:bg-darkblack-600 p-6 pb-10 transition-all relative">
            <header>
              <div>
                <h3 className="font-bold text-bgray-900 dark:text-white text-2xl mb-1">Add new card</h3>
                <p className="text-sm text-bgray-600 dark:text-darkblack-300">
                  Manage where you collect taxes and duties. Check with a tax expert if you&apos;re unsure where you
              ...
              <table className="min-w-full ">
                <thead className="border-t border-b border-bgray-300 dark:border-darkblack-500">
                  <tr className="dark:bg-darkblack-600">
                    ...
                    <th scope="col" className="px-3 py-4 dark:text-white text-left text-sm font-medium text-bgray-600">
                      Collecting
                    </th>
                    <th scope="col" className="px-3 py-4 dark:text-white text-left text-sm font-medium text-bgray-600">
                      Percentage
                  ...
                  <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                      <div className="flex gap-3 items-center">
                        <Image priority={true} height={flag.height} width={flag.width} src={flag.src} alt="" />
                        <span className="font-semibold text-sm text-bgray-900 dark:text-bgray-50 ">United States</span>
                      </div>
                    </td>
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <div className="flex gap-2 items-center">
                        <span className="font-semibold text-sm text-bgray-900 dark:text-white">One time</span>
                        <span>
                          <svg
                            width="24"
                            height="24"
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm">
                      <span className="font-semibold text-sm text-bgray-900 dark:text-white">20%</span>
                    </td>
                  </tr>
                  <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                      <div className="flex gap-3 items-center">
                        ...
                        <span className="font-semibold text-sm text-bgray-900 dark:text-white">Rest of History</span>
                      </div>
                    </td>
