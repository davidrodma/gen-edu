    ...
    <div className="p-5 rounded-lg bg-white dark:bg-darkblack-600">
      <div className="flex justify-between items-center mb-5">
        <div className="flex space-x-[7px] items-center">
          <div className="icon">
            <span>
              <Image priority={true} height={logo.height} width={logo.width} src={logo.src} alt="icon" />
            </span>
          </div>
          <span className="text-lg text-bgray-900 font-semibold dark:text-white">Total earnings</span>
        </div>
        <div>
          <Image
            priority={true}
      ...
      <div className="flex justify-between items-end">
        <div className="flex-1">
          <p className="text-bgray-900 font-bold text-3xl leading-[48px] dark:text-white">$7,245.00</p>
