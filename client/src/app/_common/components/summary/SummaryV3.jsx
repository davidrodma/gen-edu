      ...
      <div className="flex justify-between items-center pb-2 mb-2">
        <div>
          ...
          <div className="flex items-center space-x-2">
            <h3 className="sm:text-2xl text-xl text-bgray-900 dark:text-white font-bold leading-[36px]">$48,574.21</h3>
        ...
        <div className="sm:flex hidden space-x-[28px] items-center">
          ...
          <div className="flex space-x-2 items-center">
            ...
            <span className="text-bgray-700 dark:text-white text-sm font-medium">Lost</span>
          </div>
        </div>
        <DateFilter options={['Jan 10 - Jan 16', 'Jan 11 - Jan 16', 'Jan 12 - Jan 16']} />
      </div>
      <div className="w-full h-[280px]">
        <LineChart dataSet={data} option={options} plugins={plugins} refer={chartRef} />
      </div>
    </div>
  )
}
