import bra from '@/app/_common/assets/images/flag/bra.png'
import fe from '@/app/_common/assets/images/flag/fe.png'
import ita from '@/app/_common/assets/images/flag/italy.png'
    ...
    <div className="flex-1 xl:block hidden">
      <div className="w-full p-5 rounded-lg bg-white dark:bg-darkblack-600 h-full">
        <div className="flex justify-between items-center">
          <h3 className="text-xl font-bold text-bgray-900 dark:text-white">Most Location</h3>
          <div className="flex space-x-1.5 items-center">
            <span className="text-2xl font-bold text-bgray-900 dark:text-white">76,345</span>
              ...
              <div className="flex space-x-1 items-center">
                <span>
                  <svg width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    />
                    <path d="M6 0.895752H9.5V4.39575" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </span>
        ...
        <p className="text-sm text-bgray-600 dark:text-bgray-50 mb-8">Compared to last month</p>
