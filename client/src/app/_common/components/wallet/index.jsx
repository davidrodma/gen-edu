...
import card1 from '@/app/_common/assets/images/payments/card-1.svg'
import card2 from '@/app/_common/assets/images/payments/card-2.svg'
import card3 from '@/app/_common/assets/images/payments/card-3.svg'
...
function Wallet() {
  return (
    <div className="mb-6 w-full rounded-lg bg-white px-[42px] py-5 dark:border dark:border-darkblack-400 dark:bg-darkblack-600 lg:mb-0 lg:w-1/2 2xl:mb-6 2xl:w-full">
          ...
          <div className="card-slider relative w-[280px] md:w-[340px]">
            ...
            >
              <div className="w-full">
                <Image priority={true} height={card1.height} width={card1.width} src={card1.src} alt="card" />
              </div>
              <div className="w-full">
                <Image priority={true} height={card2.height} width={card2.width} src={card2.src} alt="card" />
              </div>
              <div className="w-full">
                <Image priority={true} height={card3.height} width={card3.width} src={card3.src} alt="card" />
              </div>
            </Slider>
          </div>
        </div>
      ...
      <div className="w-full">
        <h3 className="mb-4 text-lg font-bold text-bgray-900 dark:text-white">Quick Transfer</h3>
        <PaymentFilter />
        <div className="flex h-[98px] w-full flex-col justify-between rounded-lg border border-bgray-200 p-4 focus-within:border-success-300 dark:border-darkblack-400">
          <p className="text-sm font-medium text-bgray-600 dark:text-bgray-50">Enter amount</p>
          <div className="flex h-[35px] w-full items-center justify-between">
            <span className="text-2xl font-bold text-bgray-900 dark:text-white">$</span>
