  ...
  return (
    <div className="absolute top-0 right-0 pt-5 pr-5">
      ...
      >
        ...
        >
          <path d="M6 6L18 18M6 18L18 6L6 18Z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </button>
    </div>
  )
  ...
  return (
    <div className="step-content step-1">
      ...
      <div className="relative max-w-[492px] transform overflow-hidden rounded-lg bg-white dark:bg-darkblack-600 p-8 text-left transition-all">
        ...
        <div>
          <HeadingLogo />
          <h3 className="text-2xl font-bold text-bgray-900 dark:text-white mb-3">Reset your password</h3>
          ...
          <form action="">
            ...
            <Link href="/signin" className="block text-sm font-bold text-success-300 mb-8 underline">
              Return to login
            </Link>
            <button
              aria-label="none"
  ...
  return (
    <div className="step-content step-2 ">
      <div className="relative max-w-lg transform overflow-hidden rounded-lg bg-white dark:bg-darkblack-600 p-8 text-left transition-all">
        ...
        <div>
          <HeadingLogo />
          <h3 className="text-2xl font-bold text-bgray-900 dark:text-white mb-3">Enter verification code</h3>
          <p className="text-base font-medium text-bgray-600 dark:text-darkblack-300 mb-7">
          ...
          <form>
            ...
            <button aria-label="none" className="block text-sm font-bold text-success-300 mb-8">
              Send the code again
            </button>
            <button
              aria-label="none"
