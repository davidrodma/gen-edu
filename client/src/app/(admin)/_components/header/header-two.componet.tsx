...
function HeaderTwo({ handleSidebar }: { handleSidebar: (params?: any) => void }) {
      ...
      <header className="mobile-wrapper fixed z-20  block w-full md:hidden">
        <div className="flex h-[80px] w-full items-center justify-between bg-white dark:bg-darkblack-600">
          <div className="flex h-full w-full items-center space-x-5">
            <button aria-label="none" type="button" className="drawer-btn rotate-180 transform" onClick={handleSidebar}>
              <span>
          ...
          <div className="mr-2">
            <div onClick={() => handleActivePopup(!activePopup)} className="flex cursor-pointer space-x-0 lg:space-x-3">
              ...
              <div className="hidden 2xl:block">
                <div className="flex items-center space-x-2.5">
                  <h3 className="text-base font-bold leading-[28px] text-bgray-900">John Doe</h3>
                  <span>
                ...
                <p className="text-sm font-medium leading-[20px] text-bgray-600">Super Admin</p>
              </div>
            </div>
