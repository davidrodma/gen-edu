...
function ProfilePopup({ active, handlePopup }: { active: boolean; handlePopup: (params?: any) => void }) {
  return (
                ...
                <Link href={`${_routes._root}/settings`}>
                  <div className="flex items-center space-x-[18px] rounded-lg p-[14px] text-bgray-600 hover:bg-bgray-100 hover:text-bgray-900 hover:dark:bg-darkblack-500">
                    ...
                    <div className="flex-1">
                      <span className="text-sm font-semibold text-bgray-900 dark:text-white">My Profile</span>
                    </div>
                  </div>
                </Link>
              </li>
              <li className="w-full">
                <Link href={`${_routes._root}/messages`}>
